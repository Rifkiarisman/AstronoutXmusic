...
4️⃣ If userbot joined enjoy music, If not add @astronoutmusic to your group and retry
 
* 🔔 For Channel Music Play 🔔 *

1️⃣ Make bot as admin of your channel 
...
4) Add @astronoutmusicbot to the channel as an admin.
5) Simply send commands in your group.
 
* ⚫️More tools⚫️ *

• /admincache: Updates admin info of your group. Try if bot isn't recognize admin
• /userbotjoin: Invite @astronoutmusic Userbot to your chat 
